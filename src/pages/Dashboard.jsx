      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-100">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-full bg-era-red flex items-center justify-center text-white text-xs font-bold shadow-sm">AG</div>
            <div>
              <div className="text-[11px] text-gray-400">Good morning 👋</div>
              <div className="text-[14px] font-bold text-era-navy">Alex Goh</div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-100 relative">
              <Bell size={18} className="text-gray-600" />
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-era-red rounded-full" />
            </button>
            <button onClick={() => navigate('/dashboard/search')} className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-100">
